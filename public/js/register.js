...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    var checkedAgreeTerm = function checkedAgreeTerm(rule, value, callback) {
      if (value !== true) {
    ...
    return {
      ...
      rules: {
        ...
        agreeterm: [{
          required: true,
          message: '請閱讀並接受約定書及免責聲明內容',
          trigger: 'submit'
        }, {
          validator: checkedAgreeTerm,
          trigger: 'change'
        }]
      }
    };
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        {
          ref: "agreeterm",
          attrs: { label: "", prop: "agreeterm", error: _vm.agreetermerror }
        },
        [
          _c("el-checkbox", {
            model: {
              value: _vm.ruleForm.agreeterm,
              callback: function($$v) {
                _vm.$set(_vm.ruleForm, "agreeterm", $$v)
              },
              expression: "ruleForm.agreeterm"
            }
          }),
          _vm._v(" "),
          _c("span", { staticStyle: { "word-break": "break-all" } }, [
            _vm._v(
              "您已閱讀、瞭解並同意接受本約定書與及本站的使用條款及免責聲明 "
            ),
            _c("a", { attrs: { target: "_blank", href: "/term" } }, [
              _vm._v("(https://butterfliessay.com/term )")
            ]),
            _vm._v(" 之所有內容。\n      ")
          ])
        ],
